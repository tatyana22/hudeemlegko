			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_articles-->
                                            <h2 class="title text-center">Результат поиска: <?= Html::encode($q) ; ?></h2>
						...
						<div class="col-sm-12">
                                                    <div class="articles">
                                                            ...
                                                            <div class="articles-gen-img">
                                                                        <a href="<?= \yii\helpers\Url::to(['article/view', 'id' =>$article->id])?>"><?= Html::img($mainImg->getUrl('180x'), ['alt' => $article->title, 'title' => $article->title])?></a>
                                                            </div>
                                                ...
                                                <?php else:?>
                                                <h1>по вашему запросу '<?= $q ?>' ничего не найдено</h1>
                                                <?php endif;?>
