                            ...
                            <div class="col-sm-6">
                                <div class="articles">
                                    <div class="articles-gen-img">
                                        <a href="<?= \yii\helpers\Url::to(['article/view', 'id' => $article->id]) ?>"><?= Html::img("@web/images/article/{$article['img']}", ['alt' => $article['title'], 'title' => $article['title']]) ?>
...
<!--                                        <div class='caption'>
                                            <ul class='topic-info'>
                                                ...
                                                <li class='view_count'>
                                                    ...
                                                    <span class="viewcount-info">53</span>
                                                </li>
                                                <li class='vote'>
                                                    <div class="vote-count"><i class="fontello icon-chart-bar"></i> 0</div>
                                                </li>
                                            </ul>
                                        </div>-->
                                        <?php endif;?>
                                    ...
                                    <ul class="info">
                                        <li class="avatar">
                                            ...
                                            <a href="http://lifesimple.ru/blog/psihologia/"><img src="http://lifesimple.ru/uploads/images/00/00/01/2013/09/16/avatar_blog_psihologia_48x48.jpg" alt="avatar" class="topic-avatar"></a>
                                        </li>

                                        <li class="blog">
                                            <a href="http://lifesimple.ru/blog/psihologia/"><?= $article->category['name']; ?></a>
                                            <br>
                                            24.01.2017
                                        </li>																
                                    </ul>
                                    <span class="articles-comments"><?= Html::img("@web/images/article/articles-comment.jpg", ['alt' => 'Comment']) ?> <a href="#">10</a></span>
